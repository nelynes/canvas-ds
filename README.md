...
### Install
1. [Download](https://github.com/toniremi/canvas-ds/releases/download/1.0.4/canvas-ds.zip) or clone this repository. You can use the [release](https://github.com/toniremi/canvas-ds/releases) page to download the theme.
